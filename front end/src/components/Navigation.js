...
import logo from './Findmedslogo.gif';
...
selectcategory(id, name) {
  ...
  render(){
    return (
      <div>
      <nav className="navbar navbar-expand-lg" style={{ backgroundColor: "#1a2d3b" }}>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              { window.localStorage.getItem("user_role") !== 'DELIVERY_BOY' &&
                ...
                <Link to="/home">
                  <a className="nav-link nameColor2"><h5 style={{color:"#faf1cf"}}>Home</h5></a>
                </Link>
                </li>
              }
              { window.localStorage.getItem("user_role") == 'DELIVERY_BOY' &&
              ...
              <li class="nav-item dropdown">
                <h4 style={{color:"#faf1cf"}}>
                <a class="nav-link dropdown-toggle nameColor2" style={{color:"#faf1cf"}} href="myaccount" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                My Account
                </a>
              ...
              <li class="nav-item dropdown">
                <h4 style={{color:"#faf1cf"}}>
                <a class="nav-link dropdown-toggle pt-2 nameColor2" href="myaccount" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{color:"#faf1cf"}}>
                Pharmacy
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <Link to="/cart">
                <li class="nav-link">
                  <a href="#" class="cart position-relative d-inline-flex" aria-label="View your shopping cart">
                    <h5 style={{color:"#faf1cf"}}><i class="fa fa-opencart" aria-hidden="true"></i></h5>
            ...
            {!this.state.st && 
              <li className="nav-item">
                <Link to="/create-account">
                  <a className="nav-link"><h6 className="nameColor2" style={{color:"#faf1cf"}}>Sign Up <i class="fa fa-user-plus" aria-hidden="true"></i></h6></a>
                </Link>
              </li>
            }
              {!this.state.st && 
              <li className="nav-item" >
                <Link to="/login">
                  <a className="nav-link"><h6 className="nameColor2" style={{color:"#faf1cf"}}>Login <i class="fa fa-sign-in" aria-hidden="true"></i> </h6></a>
                </Link>
              </li>
              }
              {this.state.st && 
              ...
              <Link to="/myaccount/profile">
                  <a className="nav-link"><h5 className="nameColor2" style={{color:"#faf1cf"}}><i class="fa fa-user-o" aria-hidden="true"></i> Hello, {window.localStorage.getItem("user_fname")}</h5></a>
                </Link>
              </li>
            }
            </ul>
