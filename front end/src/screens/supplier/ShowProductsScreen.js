                    ...
                    <tbody>
                        {
                            ...
                            this.state.products !== null && this.state.products.map((product) => (
                                <tr >
                                    ...
                                    <td><Link to={"/supplier/updateproduct/"+product.id} className="btn" style={{ backgroundColor: "#1a2d3b",color:"#faf1cf" }}>Update Product</Link></td>
                                    <td><button className="btn" style={{ backgroundColor: "#1a2d3b",color:"#faf1cf" }} onClick={() => this.deleteProduct(product.id)}>Delete Product</button></td>
                                </tr>
                            ))
                        }
                    </tbody>
