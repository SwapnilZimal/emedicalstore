...
*/}
            ...
            <div className="mb-3">
                ...
                <button className="btn" style={{ backgroundColor: "#1a2d3b",color:"#faf1cf" }} onClick={() => this.backToOrderHistory()}>Home</button>
                </div>
                <button className="btn float-end" style={{ backgroundColor: "#1a2d3b",color:"#faf1cf" }} onClick={this.addProduct}>
                Add Product
                </button>
                <br></br>
