        ...
        return (
            <div>
                    ...
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel" >
                        ...
                        <div className="carousel-inner" >
                            <div className="carousel-item active" data-bs-interval="10000">
                                <img src="https://cms-contents.pharmeasy.in/banner/0331975d9d8-Dweb_nutrition.jpg?dim=1440x0&dpr=1.25&q=100" className="d-block w-100 " alt="image3" />
                            </div>
                            <div className="carousel-item " data-bs-interval="10000">
                                <Link to="/home">
                                    <img src="https://cms-contents.pharmeasy.in/banner/c238c3d86da-Horlicks_Primary_Dweb.jpg?dim=1440x0&dpr=1&q=100" className="d-block w-100 " alt="image1" />
                                </Link>
                            </div>
                            <div className="carousel-item" data-bs-interval="10000">
                                <img src="https://cms-contents.pharmeasy.in/banner/6685d949828-Baidynath_dweb_new.jpg?dim=1440x0&dpr=1&q=100" className="d-block w-100 " alt="image2" />
                            </div>
                ...
                <div className="container " style={{ width: "90%" }}>
                    <div class="row">
                        <div className="col-md-5"><hr /></div>
                        <div className="col-md-2"><h4>Pharmacies</h4></div>
                        <div className="col-md-5"><hr /></div>
                    </div>
                </div>
