...
class OrderHistoryScreen extends Component{
    ...
    return (
       <div>
        ...
        <h2 className="header1 text-center">Orders History</h2>
                ...
                {this.state.orders.map(
                        order =>
                            <tr key={order.id}>
                                ...
                                <td><button className="btn text-white" style={{ backgroundColor: "#1a2d3b" }} onClick={() => this.orderDetailsAddress(order.id)}>Address</button></td>
                                <td><button className="btn text-white" style={{ backgroundColor: "#1a2d3b" }} onClick={() => this.orderDetails(order.id)}>Details</button></td>                        
                            </tr>
                    )
                }
            </tbody>         
