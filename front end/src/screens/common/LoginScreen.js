      ...
      return (
        ...
        <header>
         ...
         <form>
           ...
           <div className="mb-3">
             <label className="form-label"><i class="fa fa-key" aria-hidden="true"></i> Password</label>
             <input
               type="password"
               className="form-control"
               placeholder="*****" 
           ...
           <div className="mb-3">
             ...
             <button className="btn float-end text-white" style={{ backgroundColor: "#1a2d3b" }} onClick={this.authenticateUser}>
               Login
             </button>
             <br></br>
