...
onChange = (e) =>
      ...
      addAddress(){
          ...
          // flatNo: this.state.flatNo, societyName: this.state.societyName
      let addr = { area: this.state.area, city: this.state.city, pinCode: this.state.pinCode, state: this.state.state};
    ...
    return (
      ...
      {/* <div className="row mb-3">
       ...
       <div className="row mb-3">
        ...
        <div className="mb-3">
          <button className="btn float-end" style={{ backgroundColor: "#1a2d3b",color:"#faf1cf" }} onClick={this.addAddress}>
            Register Supplier
          </button>
          <br></br>
