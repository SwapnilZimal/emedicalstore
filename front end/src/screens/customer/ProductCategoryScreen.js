            ...
            <div>
                <Navigation/>
                 <div className="container">
                    <div className="container">
                     <h4 class="header1"> { window.localStorage.getItem("category_name")} </h4>
                    ...
                    {this.state.products.map(product => 
                        <div className="product col-md-3" key={product.id}>
                            <div className="title"> 
                                <img src={'/images/'+product.productName+'.jpg'} className="d-block w-100 " alt="image" height="150px" width="50px" /><hr/>
                                <a className="nav-link" onClick={() => { this.productDetails(product) }}><h5 className="header2">{product.productName}</h5></a>
                            ...
                            className="btn  btn-add-to-cart text-white" style={{ backgroundColor: "#1a2d3b" }} >
                            Add To Cart
                        </button>
                        </div>
                        )}         
