                            ...
                            <tbody>
                                ...
                                {this.state.cart.map(product =>
                                    <tr key={product.id}>
                                        ...
                                        <td>{product.qty}</td>
                                        <td>
                                            <button class="btn text-white" style={{ backgroundColor: "#1a2d3b", color: "#faf1cf" }} onClick={() => this.deleteProduct(product.id, product.qty)}>Delete</button>
                                        </td>
                                    </tr>
                                )}
                            </tbody>
                    ...
                    <br />
                            ...
                            <div className="float"> 
                                ...
                                <h5>Savings Amount : {this.state.samt}</h5>
                                    ...
                                    <button className="btn text-white " style={{ backgroundColor: "#1a2d3b" }} onClick={() => this.addAddress()}>Add Address</button><br/><br/>

                                
                                    <button className="btn text-white " style={{ backgroundColor: "#1a2d3b"}} onClick={() => this.placeOrder()}>Place Order</button>
